      ...
      <div className="container-x relative py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16">
        <div className="flex flex-col gap-6 sm:gap-8 md:flex-row md:items-center md:justify-between md:gap-8 lg:gap-10 xl:gap-14">
          <div className="min-w-0 max-w-2xl flex-1">
            ...
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-white/70 sm:text-[12px]">
              {eyebrow}
            </p>
            ...
            <p className="mt-3 max-w-xl text-[14px] leading-relaxed text-white/75 sm:mt-4 sm:text-[15px] md:text-[16px]">
              {subtitle}
            </p>
          </div>
