...
type WaIconProps = Omit<IconProps, "ref"> & {
  size?: number;
  width?: number;
  height?: number;
};
...
/** Outline WhatsApp mark — inline SVG with padded viewBox so edges are never clipped */
export function WhatsAppIcon({ size = 20, width, height, className = "", style, ...props }: WaIconProps) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d={WA_PATH} stroke="currentColor" strokeWidth="1.15" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
