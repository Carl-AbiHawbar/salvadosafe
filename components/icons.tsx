...
type WaIconProps = Omit<ImgHTMLAttributes<HTMLImageElement>, "src" | "alt"> & {
  size?: number;
  width?: number;
  height?: number;
};

/** Outline WhatsApp mark — PNG only, no green fill */
export function WhatsAppIcon({ size = 20, width, height, className = "", style, ...props }: WaIconProps) {
  const w = width ?? size;
  const h = height ?? size;
  return (
    /* eslint-disable-next-line @next/next/no-img-element */
    <img
      src="/images/whatsapp-outline.png"
      alt=""
      width={w}
      height={h}
...
export function TruckIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" {...props}>
...
export function FlagIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" {...props}>
      <path d="M4 22V4" />
      <path d="M4 4c2.5-1 4.5 0 7 0s4.5-1 7 0v7c-2.5-1-4.5 0-7 0s-4.5-1-7 0" />
      <circle cx="14" cy="7.5" r="1" fill="currentColor" stroke="none" />
      <circle cx="16.5" cy="9" r="0.75" fill="currentColor" stroke="none" />
      <circle cx="16.5" cy="6" r="0.75" fill="currentColor" stroke="none" />
...
export function AwardIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" {...props}>
      ...
      <path d="M8.5 13.2 7 22l5-2.8L17 22l-1.5-8.8" />
      <path d="M9.5 8h5M12 5.5V10.5" />
    </svg>
  );
}
